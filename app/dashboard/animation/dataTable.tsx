...
import { Animation as Payment } from "@/lib/types";
...
import { deleteAnimation } from "@/lib/actions";
export const columns: ColumnDef<Payment>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("presentateurnom")}</div>
    ),
  },
  {
    accessorKey: "role",
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Etes-vous sur de supprimer définitivement l&apos;animation de{" "}
                  {row.original.presentateurnom} pour le programme{" "}
                  {row.original.programmenom} ?
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter className="justify-end">
                ...
                <Button
                  ...
                  onClick={async () => {
                    try {
                      await deleteAnimation(row.original.id || 0);
                      toast({
                        title: "Supprimer",
                        description: `l'animation ${row.original.id} a été supprimer avec succès`,
  ...
  return (
    <div className="w-full px-4 pt-4">
      <div className="flex items-center pb-4">
        <Input
          placeholder="Rechercher animation..."
