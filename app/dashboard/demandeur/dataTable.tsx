...
export const columns: ColumnDef<Payment>[] = [
  {
    ...
    header: "Id",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("nummatricule")}</div>
    ),
  },
  {
      ...
      return (
        <div className="flex gap-3">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  ...
                  href={`/dashboard/demandeur/ajouter`}
                >
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  className="flex gap-3"
                  href={`/dashboard/demandeur/${row.original.nummatricule}`}
                >
              ...
              <TooltipContent className="flex gap-2 justify-center items-center">
                ...
                <p>modifier le demandeur {row.original.nomdemandeur}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <Dialog>
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="flex gap-2 justify-center items-center">
                  ...
                  <p>supprimer le demandeur {row.original.nomdemandeur}</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle> Suppression demandeur</DialogTitle>
                <DialogDescription>
                  Etes-vous sur de supprimer du demandeur{" "}
                  {row.original.nomdemandeur} définitivement?
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter className="justify-end">
                ...
                <Button
                  ...
                  onClick={async () => {
                    try {
                      await deleteDemandeur(Number(row.original.nummatricule));
                      toast({
                        title: "Supprimer",
                        description: `le demandeur ${row.original.nomdemandeur} a été supprimer avec succès`,
    ...
    <div className="w-full px-4 pt-4">
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        <div className="flex-1 text-sm text-muted-foreground">
          Total : {table.getFilteredRowModel().rows.length} demandeur(s).
        </div>
